...
my_ball = Ball(table=my_table, x_speed=10, y_speed=0, width=24, height=24, color="red", x_posn=((600-24)/2), y_posn=((400-24)/2))

### 배트 생성
# Bat 클래스로부터 배트를 주문
# Bat(self, table, width, height, x_posn, y_posn, color, x_speed = 25, y_speed = 25)
bat_L = Bat(table=my_table, y_speed=15, width=24, height=100, color="green", x_posn=0, y_posn=((400-100)/2))
bat_R = Bat(table=my_table, y_speed=15, width=24, height=100, color="blue", x_posn=(600-24), y_posn=((400-100)/2))
